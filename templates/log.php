...
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Data Sent','contact-form-insightly-crm') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Nothing Posted to Insightly','contact-form-insightly-crm');?></div>      
      <?php
  }
?>
</div></div>
    ...
    if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Insightly Response','contact-form-insightly-crm') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','contact-form-insightly-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('More Detail','contact-form-insightly-crm') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','contact-form-insightly-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
?>
 ...
 if($error){
  ?>
<div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Detail Not Found','contact-form-insightly-crm');?></div>  
  <?php   
 } ?>
...
?>
<a href="<?php echo esc_url($feed_link) ?>" title="<?php esc_html_e('Edit Feed','contact-form-insightly-crm') ?>" class="button"><i class="fa fa-edit"></i> <?php esc_html_e('Edit Feed','contact-form-insightly-crm') ?></a>
<?php
    }
?>
<a href="<?php echo esc_url($log_link) ?>" title="<?php esc_html_e('Open in New Window','contact-form-insightly-crm') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php esc_html_e('Open in New Window','contact-form-insightly-crm') ?></a>
<a href="#" class="button vx_close_detail" title="<?php esc_html_e('Close','contact-form-insightly-crm') ?>"><i class="fa fa-times"></i> <?php esc_html_e('Close','contact-form-insightly-crm') ?></a>
